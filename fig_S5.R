...
quincy_copper <- quincy %>%
  ...
  geom_point(size = 2) +
  geom_vline(xintercept = 0.0005, linetype = "dashed", color = "black") +
...
ggsave("C:/Users/Jim Byrne/Documents/Phd/research/neochlamydia/letter_figs/Draft 14/fig_S5.tiff",plot = last_plot(), width = 7, height = 4.167, dpi = 300, units = "in", grDevices::tiff)
